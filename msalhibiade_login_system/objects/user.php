...
class User{
    ...
    function emailExists(){
        ...
        $stmt->bindValue(':value', $this->email);
        // execute the query
        $stmt->execute();
        // get number of rows
        $num = $stmt->rowCount();
    ...
    function create(){
        ...
        // bind the values
        $stmt->bindValue(':value1', $this->firstname);
        $stmt->bindValue(':value2', $this->lastname);
        $stmt->bindValue(':value3', $this->email);
        $stmt->bindValue(':value4', $this->contact_number);
        $stmt->bindValue(':value5', $this->address);
        // hash the password before saving to database
        $password_hash = password_hash($this->password, PASSWORD_BCRYPT);
        $stmt->bindValue(':value6', $password_hash);
        $stmt->bindValue(':value7', $this->access_level);
        $stmt->bindValue(':value8', $this->access_code);
        $stmt->bindValue(':value9', $this->status);
        $stmt->bindValue(':value10', $this->created);
